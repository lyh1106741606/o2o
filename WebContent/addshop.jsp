...
<div class="header">
    <div class="w">
		...
		<div class="body body-s">		
			<form action="shop/add.do" method="post" enctype="multipart/form-data" id="sky-form" class="sky-form">
				<header>店长：${person.name }|添加新店</header>
				...
				<fieldset>	
					<section>
						<label class="select">
							<select name="areaId">
								<option value="0" selected disabled>商店区域</option>
					...
					<section>
						<label class="select">
							<select name="shopCategoryId">
								<option value="0" selected disabled>商店类型</option>
				...
				<fieldset>
					<section>
						<label class="input">
							...
							<input type="text" name="shopName" placeholder="商店名称">
						</label>
					</section>
					<section>
						<label class="input">
							<i class="icon-append icon-user"></i>
							<input type="text" name="shopAddr" placeholder="商店地址">
						</label>
					</section>
					<section>
						<label class="input">
				...
				<fieldset>						
					<section>
						...
						<label class="input">
							...
							<input type="file" name="image" placeholder="商店图片" /> 
						</label>
					</section>
				</fieldset>
				...
				<fieldset>	
					<section>
							请输入商店简介：
							<textarea name="shopDesc" rows="3" cols="50"/></textarea>
