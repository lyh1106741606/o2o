        ...
        <div class="page-wrap w">
			<div class="w">
				...
				<div class="floor-wrap" >
				    <h1 class="floor-title">已冻结用户列表</h1>
				       <ul class="floor-list" >
				      	       <c:forEach var="person" items="${person0List }">
						           <li class="floor-item">
						                
						                <span class="floor-text">${person.name }</span>
						                <img class="floor-img" src="image/person/${person.profileImg }" alt="${person.name }"  />
				...
				<div class="floor-wrap" >
				    <h1 class="floor-title">正常使用用户列表</h1>
				       <ul class="floor-list" >
