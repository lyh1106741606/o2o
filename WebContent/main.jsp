...
<html>
  <head>
    <base href="<%=basePath%>">
    <script type="text/javascript" charset="UTF-8" src="jquery/prefixfree.min.js"></script>
	<link rel="stylesheet" type="text/css" href="page/base.css" media="all" />
	<style type="text/css">
		body {
		...
		<section class="demo">
			<div class="admin-panel clearfix">
				<div class="slidebar">
					...
					<ul>
						<li><a href="login.jsp" id="targeted">dashboard</a></li>
